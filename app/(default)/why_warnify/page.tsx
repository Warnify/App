    ...
    <><section>
        ...
        <div className="grid grid-cols-2 mb-16">
            <div className="ml-20 mt-20">
                ...
                <p className="pr-20 text-lg text-gray-700 dark:text-gray-400">
                   Victims of financial loss, identity theft, privacy breach, emotional distress, and more have all suffered gravely through scams from text messages. The damage is irreversible. Lives are ruined and all the hard work is scrubbed out in seconds. This is where we come in. <span className=" text-gray-800 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-b dark:from-indigo-200 dark:to-gray-200">We Protect what matters most: your <span className="font-bold">trust</span> and <span className="font-bold">privacy</span>. </span> Our mission is to break the vicious cycle of SMS Fraud and bring back safety in your digital experience.
                </p>
            </div>
            
            <Image
              className="inset-0 object-cover object-end"
              src={mission}
              width={750}
              height={750}
        ...
        <div className="grid grid-cols-2">
            <div className="bg-blue-500 rounded-lg px-12 py-12 mx-32 my-6">
                <h1 className="bg-blue-700/70 font-inter-tight rounded-full py-4 pl-8 pr-3 ml-11">Hello Amanda, your FEDEX package with tracking code GB-6412-GH83 is waiting for you to set delivery preferences: http://fedex-login.com</h1>
