  ...
  return (
    <div className={`max-w-3xl mx-auto ${className || ""}`}>
      <div className="text-center">
        ...
        <div>
          <h1 className="font-inter-tight text-3xl sm:text-6xl font-bold text-gray-800 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-b dark:from-indigo-200 dark:to-gray-200 pb-4">
            {title}
          </h1>
          <p className="text-sm sm:text-lg text-gray-700 dark:text-gray-400">
            {description}
          </p>
        </div>
      </div>
